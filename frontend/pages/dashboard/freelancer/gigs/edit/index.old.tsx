...
import GigGallaryInput from "@/features/gig/components/GigGallaryInput.old";
...
const FreelancerEditGigPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof gigSchema>) => {
    ...
    values.freelancerId = user?.freelancer?.id || freelancer?.id;
          ...
          <div className="col-span-12">
            <div className="flex h-full flex-col items-center justify-center space-y-2">
              ...
              <div className="flex space-x-2">
                <Tooltip title="Update gig and open review gig pagge">
                  <Button
