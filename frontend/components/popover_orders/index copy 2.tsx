...
import { Badge, Divider, Button, CircularProgress, Tooltip } from "@mui/material";
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">
                      by <span className="font-semibold text-gray-700">{order.seller}</span>
                    </p>
