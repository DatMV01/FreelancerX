...
export const programmingTechSubCategories = [
  {
    ...
    parent_category_id: "3f1c9d2e-7b5a-4a8d-9e1c-2b7a1e5d3c4f",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "8e2d1a7b-3c9f-4d5a-6b1e-2f7a4c8d3e9f",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "8c2d3f5f-907d-4f98-b5b5-bc5a1c8b8d13",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "b8e4d703-9e6b-4f2f-a9a0-94d4f2643c6f",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "a2d98fc3-cb99-4655-9eaf-92cfb2134d84",
        title: "AI Chatbot",
        slug: "ai-chatbot",
      },
      {
    ...
    subCategories: [
      {
        ...
        parent_category_id: "8fefea57-cff4-4690-bba9-febcb87283b3",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "ded4b34f-29a3-48f2-bbd5-101d42a6ecde",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "76bfc0a1-b62d-497a-b5a4-e6ea1c033ff0",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "26b73c6d-6f68-4781-9c76-35d903c5b563",
    ...
    subCategories: [
      {
        ...
        parent_category_id: "8c2a6e1f-4d65-4d7d-9490-8d3fbe1e48fa",
