...
export default function GigFrequentlyAskedQuestionsInput({
  faqs,
  onFAQsCb,
}: {
  faqs?: any;
  ...
  const [faqList, setQaList] = useState<FAQ[]>(faqs || []);
  ...
  return (
    <div className="w-full bg-gray-50 p-4">
      <input
        ...
        maxLength={300}
        className="mb-2 w-full rounded-md border p-2 focus:ring focus:ring-gray-300 focus:outline-none"
      />
      ...
      <textarea
        ...
        maxLength={300}
        className="mb-2 h-36 w-full resize-none rounded-md border p-2 focus:ring focus:ring-gray-300 focus:outline-none"
      ></textarea>
