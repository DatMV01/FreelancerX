    ...
    <div className="flex h-full flex-col items-center justify-between gap-y-2 px-4">
      <div className="w-full rounded-xs p-2">
        <div className="text-muted-foreground space-y-4 text-sm">
          ...
          <div>
            <div>{walletTransaction.metadata.bankInfo.bankName}</div>
            <div>{walletTransaction.metadata.bankInfo.swiftCode}</div>
            <div>{walletTransaction.metadata.bankInfo.accountNumber}</div>
            <div>{walletTransaction.metadata.bankInfo.accountHolderName}</div>
          </div>
