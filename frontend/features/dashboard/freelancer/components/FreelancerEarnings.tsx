...
import { BadgeDollarSign, Banknote, FileDown, Info } from "lucide-react";
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent side="top">
                      <p>
                        Tổng tất cả thu nhập từ các đơn hàng, bao gồm cả số chưa
                        rút và đơn đang chờ.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ...
                <div className="text-muted-foreground flex items-center gap-1 text-sm">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent side="top">
                        <p>
                          Số tiền bạn có thể rút ngay, sau khi trừ hoàn tiền,
                          hoa hồng và đơn chưa xử lý.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
